...
Feature: Clerk using software
  ...
  @tag1
  Scenario: As a clerk, I want to register a patient 
  so that we can have a record of all the patients in the hospital.
  ...
  Scenario: As a clerk, I want to be able to search for patients so that
  I can access their registration/admission data.
  	Given That I am a clerk
  	And I have a patient register
  ...
  Scenario: As a clerk, I want to be able to edit a patinent's
